...
from WachatMsgServer.itools.log import log, logger
...
# image_db_path = "./WXDateBase/Database/Msg/HardLinkImage.db"
# video_db_path = "./WXDateBase/Database/Msg/HardLinkVideo.db"


# image_db_path = os.path.join(BASE_DIR,
#                        'WachatMsgServer',
#                        'itools','WXDateBase',
#                        'Database','Msg','HardLinkImage.db')
#
# video_db_path = os.path.join(BASE_DIR,
#                        'WachatMsgServer',
#                        'itools','WXDateBase',
#                        'Database','Msg','HardLinkVideo.db')
...
class HardLink:
    ...
    def init_database(self,db_Pathes=None):
        image_db_path = os.path.join(db_Pathes,'HardLinkImage.db')

        video_db_path = os.path.join(db_Pathes,'HardLinkVideo.db')
...
if __name__ == "__main__":
    msg_root_path = "../WXDateBase/Msg/"
    image_db_path = "../WXDateBase/Msg/HardLinkImage.db"
    video_db_path = "../WXDateBase/Msg/HardLinkVideo.db"
