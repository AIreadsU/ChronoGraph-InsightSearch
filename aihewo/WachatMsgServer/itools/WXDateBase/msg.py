...
from WachatMsgServer.itools.person import Contact,ContactDefault
from WachatMsgServer.itools.log import logger
from WachatMsgServer.itools.util.compress_content import parser_reply
from WachatMsgServer.itools.util.protocbuf.msg_pb2 import MessageBytesExtra
from djangoProject.settings import BASE_DIR

#db_path = "./WXDateBase/Database/Msg/MSG.db"
...
def parser_chatroom_message(messages):
    from . import micro_msg_db, misc_db, close_db
    # from WXDateBase import micro_msg_db, misc_db
...
class Msg:
    ...
    #     global db_path
    def init_database(self, path=None, db_Pathes=None):
        db_path = os.path.join(db_Pathes,'MSG.db')
