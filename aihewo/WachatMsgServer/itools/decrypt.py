...
from .WXDateBase.merge import merge_databases, merge_MediaMSG_databases
#from WXDateBase.merge import merge_databases, merge_MediaMSG_databases

def run(key,db_path,DB_DIR):
    output_dir = DB_DIR
...
# WXdb_path = os.path.join(BASE_DIR,
#                        'WachatMsgServer',
#                        'DateBase',
#                        'wxid_yzy19wfvnozj21','Msg')
# db_path = os.path.join(BASE_DIR,
#                        'WachatMsgServer',
#                        'itools','WXDateBase',
#                        'Database','Msg')
# run("C39AB14DC45D4D5FA30CC1733137AB76BCC393DE1EFC4589A6136D7E9EC06FC6",
#         WXdb_path,
#         db_path)
...
#                        'WachatMsgServer',
#                        'DateBase',
#                        'wxid_yzy19wfvnozj21','Msg',"Applet.db")
# db_path = os.path.join(BASE_DIR,
#                        'WachatMsgServer',
#                        'itools','WXDateBase',
#                        'Database','Msg',"Applet.db")
#
# decrypt("C39AB14DC45D4D5FA30CC1733137AB76BCC393DE1EFC4589A6136D7E9EC06FC6".lower(),
#         WXdb_path,
#         db_path)
